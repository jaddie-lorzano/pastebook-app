...
const routes: Routes = [
  ...
  {path: ':username/albums', pathMatch: 'full', component:AlbumGalleryPageComponent},
  {path: ':username/albums/:id', pathMatch: 'full', component:AlbumComponent},
  {path: ':username/friendrequest', pathMatch: 'full', component:FriendRequestPageComponent},
